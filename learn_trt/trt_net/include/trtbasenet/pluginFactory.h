...
namespace TrtNet {
  ...
  class PluginFactory : public nvinfer1::IPluginFactory,
   ...
   public:
    ...
    /**
     * @brief Create trt layer plugin with layername,serialdata,serialength.
     */
